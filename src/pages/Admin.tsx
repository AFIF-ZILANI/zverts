        ...
        const init = async () => {
            ...
            const [{ data: u }, { data: l }, { data: s }] = await Promise.all([
                supabase
                    .from("profiles")
                    .select(
                        "id,name,email,last_active,user_progress(total_gems,total_xp,current_streak)",
                    )
            ...
            <section className="container py-12">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                    ...
                    >
                        ...
                        <p className="text-xs text-muted-foreground font-mono mt-2">
                            Phone numbers from student popup
                        </p>
                    </Link>
                    <Link
                        to="/admin/broadcast"
                ...
                <div className="rounded-2xl border border-border bg-gradient-card p-6 shadow-card">
                    ...
                    {logs.length === 0 ? (
                        <p className="text-sm text-muted-foreground font-mono">
                            No emails sent yet. Email infrastructure activates after a domain is
                            configured.
                        </p>
                    ) : (

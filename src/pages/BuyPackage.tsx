    ...
    <AppShell>
      <section className="container py-10 md:py-14 max-w-6xl space-y-10">
        ...
        <div className="rounded-2xl border border-border bg-card p-5 flex flex-wrap gap-6">
          ...
          <div className="flex items-center gap-2 text-sm">
            <Sparkles className={`h-4 w-4 shrink-0 ${ent.ai_enabled ? "text-primary" : "text-muted-foreground"}`} />
            <span className="text-muted-foreground">AI Tutor:</span>
            <span className={`font-semibold ${ent.ai_enabled ? "text-primary" : "text-muted-foreground"}`}>
              ...
              >
                ...
                <ul className="space-y-2.5 text-sm flex-1">
                  <li className="flex items-start gap-2">
                    ...
                    <span>{p.credits} playlist convert{p.credits > 1 ? "s" : ""}</span>
                  </li>
                  <li className="flex items-start gap-2">

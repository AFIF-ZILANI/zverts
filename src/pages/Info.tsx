    ...
    },
    {
        ...
        sections: [
            { heading: "Customer Support", body: "For technical or account-related issues." },
            {
                ...
                body: "Partnerships, collaborations, or enterprise opportunities.",
            },
                    ...
                    {page.sections.map((s, i) => (
                        <section
                            ...
                            className={
                                ...
                                (!s.heading && !s.bullets
                                    ? "md:col-span-2 text-center italic text-muted-foreground"
                                    : "")
                            }
                        >
                            {s.heading && (
                ...
                {["contact", "support", "help", "about"].includes(page.slug) && (
                    <section className="mt-10">
                        ...
                        <p className="mt-3 text-xs text-muted-foreground">
                            For support, business inquiries, partnerships, premium issues, and
                            refund requests.
                        </p>
                    </section>
                )}

...
const TranscriptView = ({
    ...
    if (loading)
        return <div className="text-xs font-mono text-muted-foreground">Loading transcript…</div>;
        ...
        return (
            <div className="space-y-3">
                ...
                <p className="text-[10px] text-muted-foreground leading-relaxed">
                    Transcription runs in the background. The panel updates automatically when it's
                    ready.
                </p>
            </div>
        );
        ...
        return (
            <div className="rounded-xl border border-primary/30 bg-primary/5 p-4 text-xs leading-relaxed">
                ...
                <p className="text-muted-foreground">
                    Vert will use the transcript to ground answers and let you click any line to ask
                    about it.
                </p>
            </div>
        );

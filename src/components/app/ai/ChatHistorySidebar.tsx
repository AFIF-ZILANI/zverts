        ...
        <div className="flex flex-col h-full bg-card/80 backdrop-blur-xl border-r border-border/60 w-64">
            <div className="p-3 border-b border-border/60 flex items-center gap-2">
                <Button
                    onClick={onNew}
                    size="sm"
                    className="flex-1 h-8 bg-gradient-lime text-primary-foreground hover:opacity-90"
                >
            ...
            <div className="flex-1 overflow-y-auto p-2 space-y-3">
                {pinned.length > 0 && (
                    <div>
                        <div className="px-2 mb-1 text-[10px] font-mono uppercase tracking-widest text-muted-foreground">
                            Pinned
                        </div>
